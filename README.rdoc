...
== knife elb modify ELB ( options )

Available options include:

    --enable-connection-draining  (default: disabled)
    --connection-draining-timeout (default: 300)
    --enable-cross-zone-balancing (default: disabled)
    --connection-idle-timeout     (default: 60)
